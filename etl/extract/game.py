...
class Game:
    def __init__(self, espn_game: dict, cbs_game: BeautifulSoup, cbs_odds: BeautifulSoup, fox_url: str, fox_game: BeautifulSoup):
        ...
        self.away_q1_score: int = espn.extract_away_box_score(espn_game)["q1"]
        self.away_q2_score: int = espn.extract_away_box_score(espn_game)["q2"]
        self.away_q3_score: int = espn.extract_away_box_score(espn_game)["q3"]
        self.away_q4_score: int = espn.extract_away_box_score(espn_game)["q4"]
        self.away_overtime_score: int = espn.extract_away_box_score(espn_game)["ot"]
        self.away_total_score: int = espn.extract_away_box_score(espn_game)["total"]
        self.home_q1_score: int = espn.extract_home_box_score(espn_game)["q1"]
        self.home_q2_score: int = espn.extract_home_box_score(espn_game)["q2"]
        self.home_q3_score: int = espn.extract_home_box_score(espn_game)["q3"]
        self.home_q4_score: int = espn.extract_home_box_score(espn_game)["q4"]
        self.home_overtime_score: int = espn.extract_home_box_score(espn_game)["ot"]
        self.home_total_score: int = espn.extract_home_box_score(espn_game)["total"]
