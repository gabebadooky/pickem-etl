...
class Team:
    def __init__(self, espn_team: dict, cbs_team: BeautifulSoup):
        ...
        self.ranking: int = espn.extract_ranking(espn_team)
        self.conference_wins: int = 0
        self.conference_losses: int = 0
        self.conference_ties: int = 0
        self.overall_wins: int = espn.extract_overall_record(espn_team)["wins"]
        self.overall_losses: int = espn.extract_overall_record(espn_team)["losses"]
        self.overall_ties: int = espn.extract_overall_record(espn_team)["ties"]
