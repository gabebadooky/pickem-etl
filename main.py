...
cfb_cbs_scoreboard_week_url: str = "https://www.cbssports.com/college-football/scoreboard/FBS/2025/regular"
...
nfl_cbs_scoreboard_week_url: str = f"https://www.cbssports.com/nfl/scoreboard/all/2025/regular"
...
def full_etl(league: str, weeks: int, espn_scoreboard_endpoint: str, espn_team_endpoint: str, cbs_scoreboard_week_url: str):
    ...
    distinct_teams: dict = etl.extract_and_load_games(league, weeks, espn_scoreboard_endpoint, cbs_scoreboard_week_url)
